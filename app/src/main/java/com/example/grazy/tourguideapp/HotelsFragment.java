...
/**
 * {@link Fragment} that displays a list of hotels in Armacao de Pera - Portugal.
 */
public class HotelsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        places.add(new Places(R.string.holidayinn_hotel, R.drawable.hotel_1));
        places.add(new Places(R.string.lindomar_hotel, R.drawable.hotel_2));
        places.add(new Places(R.string.rosa_mar_hotel, R.drawable.hotel_3));
