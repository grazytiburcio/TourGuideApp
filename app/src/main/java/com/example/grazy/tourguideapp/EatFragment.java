...
public class EatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        places.add(new Places(R.string.rocha_da_palha_restaurant, R.drawable.eat_1));
        places.add(new Places(R.string.olivalmar_restaurant, R.drawable.eat_2));
        places.add(new Places(R.string.coentros_restaurant, R.drawable.eat_3));
